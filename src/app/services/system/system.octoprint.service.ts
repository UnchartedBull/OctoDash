...
export class SystemOctoprintService implements SystemService {
  ...
  public sendCommand(command: string): void {
    this.http
      ...
      .pipe(catchError(error => this.notificationService.setError($localize`Can't execute ${command} command!`, error.message)))
      .subscribe();
  }
  ...
  public connectPrinter(): void {
    ...
    this.http
      ...
      .pipe(catchError(error => this.notificationService.setError($localize`Can't connect to printer!`, error.message)))
      .subscribe();
  }
}
