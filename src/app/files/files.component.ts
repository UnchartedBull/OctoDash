    ...
    setTimeout((): void => {
      ...
      this.filesService.getFolderContent(folderPath).subscribe(
        ...
        (error: HttpErrorResponse) => {
          this.notificationService.setError($localize`Can't load file/folder!`, error.message);
          this.currentFolder = folderPath;
        },
        () => {
          this.hideLoader();
  ...
  public openDetails(filePath: string): void {
    this.filesService.getFile(filePath).subscribe(
      ...
      (error: HttpErrorResponse) => {
        ...
        this.notificationService.setError($localize`Can't load file!`, error.message);
      },
    );
